...
def main() -> int:
    expected_paths = [
        ...
        ROOT / "Dockerfile",
        ROOT / "README.md",
        ROOT / "examples" / "procurement_demo.csv",
        ROOT / "deploy" / "cloud" / "aws" / "README.md",
        ROOT / "deploy" / "cloud" / "aws" / "terraform" / "main.tf",
        ROOT / "deploy" / "kubernetes" / "base" / "api-deployment.yaml",
        ROOT / "deploy" / "kubernetes" / "overlays" / "local" / "kustomization.yaml",
        ...
        ROOT / "docs" / "release" / "v1.0-checklist.md",
        ROOT / "docs" / "release" / "v1.0-demo-assets.md",
        ROOT / "docs" / "release" / "v1.0-demo-walkthrough.md",
        ROOT / "docs" / "release" / "v1.0-release-notes.md",
        ...
        ROOT / "scripts" / "validate_runtime_config.py",
        ...
        ROOT / "src" / "aeai_os" / "runs" / "factory.py",
        ROOT / "src" / "aeai_os" / "runs" / "sqlalchemy_repository.py",
        ROOT / "src" / "aeai_os" / "web" / "static" / "run-inspector.html",
        ROOT / "src" / "aeai_os" / "web" / "static" / "run-inspector.css",
        ROOT / "src" / "aeai_os" / "web" / "static" / "run-inspector.js",
