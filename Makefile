...
.PHONY: install test lint format smoke demo k8s-validate cloud-validate production-validate release-package db-upgrade db-validate dev up down
...
production-validate:
	PYTHONPATH=. $(PYTHON) scripts/validate_production_readiness.py
